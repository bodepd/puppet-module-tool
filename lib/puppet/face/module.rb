...
#
  action :generate do
    ...
    examples "puppet module generate USERNAME-MODNAME"
    description <<-EOT
      Generate a module
      -----------------
...
#  end
  ...
  action :build do
    ...
    examples "puppet module build [PATH_TO_MODULE]"
    description <<-EOT
...
#    description <<-EOT
#      Creates a symlink to your module at the specified modulepath
#    EOT
#    when_invoked do
#
#    end
